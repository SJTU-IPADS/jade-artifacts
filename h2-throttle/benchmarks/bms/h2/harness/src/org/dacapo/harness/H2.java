...
public class H2 extends Benchmark {
  ...
  private Method preIterationWithThrottleTPCC;
  ...
  protected void prepare() throws Exception {
    ...
    try {
      ...
      this.preIterationWithThrottleTPCC = tpccClazz.getMethod("preIteration", String.class, Integer.class);
  ...
  public void preIteration(String size, Integer throttle) throws Exception {
    ...
    useBenchmarkClassLoader();
    try {
      this.preIterationWithThrottleTPCC.invoke(this.tpcc, size, throttle);
    } finally {
      revertClassLoader();
    }
  }
