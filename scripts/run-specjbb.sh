...
do
    ...
    rm -r ../results/specjbb/jade-heap${HEAPCONFIGNAME} 
    ...
    rm -r ../results/specjbb/genshen-heap${HEAPCONFIGNAME} 
    ...
    rm -r ../results/specjbb/genz-heap${HEAPCONFIGNAME}
    ...
    then
        ...
        rm -r ../results/specjbb/lxr-heap${HEAPCONFIGNAME}
